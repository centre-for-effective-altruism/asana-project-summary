...
TASK_FIELDS=name,custom_fields,created_at,completed_at,memberships.section.name
...
echo '================'
#echo $ASANA_PROJECTS | jq .
echo $ASANA_VALUE_FIELD_GID
...
EOF
# remove backlog   select(.memberships.
